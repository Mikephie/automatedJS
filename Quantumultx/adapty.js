...
[rewrite_local]
^https?:\/\/api\.adapty\.io\/api\/v\d\/sdk\/(analytics\/profiles|in-apps\/(apple\/receipt\/validate|purchase-containers)|purchase\/app-store) url script-response-body adapty-auto.js
...
const SETTINGS = {
    ...
    NOTIFICATION: {
        ENABLED: true,            // 通知开关
        INTERVAL: 60 * 60 * 1000, // 同一应用通知间隔(毫秒)：1小时
    },
